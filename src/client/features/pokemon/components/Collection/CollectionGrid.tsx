  ...
  return (
    <div className="grid grid-cols-4 gap-2.5 p-1 sm:grid-cols-6 lg:grid-cols-9">
      {pokemonSpecies.map((species) => {
        ...
        return caught ? (
          <div key={species.id} className="relative flex flex-col items-center rounded-lg border-[3px] border-ink-soft bg-card p-2 shadow-[3px_3px_0_0_var(--color-ink-soft)]">
